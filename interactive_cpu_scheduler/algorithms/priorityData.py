class priorityData:
    ...
    def presentationOrderProcess(self,listToOrder):
        ...
        for i in range(0,len(listToOrder)):
            ...
            cadenaFinal = f"{cadenaFinal} {listToOrder[i].idProcess * listToOrder[i].rafagaCPU}|"
...
def main(processes, priorities):
    ...
    #for pid, rafagaCPU, timeLlegada in processes,priorities:
     #   obj = priorityData(pid, rafagaCPU, timeLlegada,priorities[t])
      #  t+1
       # listProcess.append(obj)
        #listProcess = obj.orderPriority(listProcess)
    ...
    result = [averageTimeWait,averageTimeReturn,listPriority]
    return result